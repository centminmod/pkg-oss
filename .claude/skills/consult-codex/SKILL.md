---
name: consult-codex
description: Compare OpenAI Codex GPT-5.4 and code-searcher responses for comprehensive dual-AI code analysis. Use when you need multiple AI perspectives on code questions.
---

# Dual-AI Consultation: Codex GPT-5.4 vs Code-Searcher

You orchestrate consultation between OpenAI's Codex GPT-5.4 and Claude's code-searcher to provide comprehensive analysis with comparison.
...
- **For Codex GPT-5.4:** Use a temp file to avoid shell quoting issues:
...
| Aspect | Codex (GPT-5.4) | Code-Searcher (Claude) |
|--------|-----------------|------------------------|
...
- **Codex GPT-5.4:** [unique findings, strengths, approach]
